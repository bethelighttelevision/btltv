            ...
            <div className="flex justify-center items-center gap-8 md:gap-12 flex-wrap">
              {PARTNERS.map((partner, index) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.08, rotateY: 8, rotateX: -4, z: 40 }}
                ...
                >
                  <div className="relative">
                    ...
                    <Card className="relative bg-btl-card/80 border-btl-card-border hover:border-btl-red/40 transition-all duration-500 flex items-center justify-center p-6 md:p-8 h-32 w-48 md:h-40 md:w-60 backdrop-blur-sm group-hover:shadow-[0_0_30px_rgba(229,9,20,0.15)]">
                      ...
                      <img src={partner.logo} alt={partner.name} width={400} height={228} loading="lazy" className="max-h-20 md:max-h-24 max-w-full object-contain brightness-90 contrast-110 group-hover:brightness-110 group-hover:contrast-125 transition-all duration-500 drop-shadow-[0_0_8px_rgba(229,9,20,0.1)] group-hover:drop-shadow-[0_0_16px_rgba(229,9,20,0.25)]" />
                    </Card>
                  </div>
                  <p className="text-center text-[11px] md:text-xs text-muted-foreground mt-2 font-medium group-hover:text-btl-red transition-colors duration-300">{partner.name}</p>
                </motion.div>
              ))}
            </div>
          </div>
