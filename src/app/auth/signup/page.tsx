      ...
      >
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <div className="space-y-4 text-right">
            <div className="relative">
              <Input
                ...
                disabled={loading}
              />
              <User className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 h-5 w-5" />
            </div>
          ...
          <Button type="submit" disabled={loading} className="w-full h-12 bg-btl-red hover:bg-btl-red-dark text-white font-urdu text-lg rounded-lg transition-transform active:scale-95 disabled:opacity-60">
            {loading ? <><Loader2 className="h-5 w-5 ml-2 animate-spin inline" /> براہ کرم انتظار کریں</> : "اکاؤنٹ بنائیں"}
          </Button>
        </form>
        ...
        <div className="mt-8">
          <div className="relative flex items-center justify-center mb-6">
            ...
            <span className="relative bg-[#1f1f1f] px-4 text-sm text-gray-400 font-urdu rounded-full">یا اس سے رجسٹر کریں</span>
          </div>
